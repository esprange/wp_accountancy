...
class Test_Transaction extends UnitTestCase {
	...
	public function test_create() : void {
		$transaction1            = new Transaction( $this->business );
		$transaction1->reference = 'test-transaction';
		$transaction1->type      = 'test';
		$transaction_id          = $transaction1->update();

		$transaction2 = new Transaction( $this->business, $transaction_id );
	...
	public function test_update() : void {
		...
		$transaction3 = new Transaction( $this->business, $transaction_id );
	...
	public function test_query() : void {
		...
		$query = ( new TransactionQuery( $this->business ) )->get_results();
