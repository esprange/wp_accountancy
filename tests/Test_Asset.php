...
class Test_Asset extends UnitTestCase {
	...
	public function test_create() : void {
		$asset1       = new Asset( $this->business );
		$asset1->name = 'test-asset';
		$asset1->cost = 123.45;
		$asset_id     = $asset1->update();

		$asset2 = new Asset( $this->business, $asset_id );
	...
	public function test_update() : void {
		...
		$asset3 = new Asset( $this->business, $asset_id );
	...
	public function test_query() : void {
		...
		for ( $index = 0; $index < $amount; $index++ ) {
			$asset       = new Asset( $this->business );
			$asset->name = "test-asset_$index";
			$asset->update();
		}
		$query = ( new AssetQuery( $this->business ) )->get_results();
